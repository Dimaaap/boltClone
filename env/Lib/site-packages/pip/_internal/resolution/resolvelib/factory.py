...
class Factory:
    ...
    def _iter_found_candidates(
        ...
        template = ireqs[0]
        assert template.req, "Candidates found on index_page must be PEP 508"
        name = canonicalize_name(template.req.name)

        extras: FrozenSet[str] = frozenset()
        for ireq in ireqs:
            assert ireq.req, "Candidates found on index_page must be PEP 508"
        ...
        def _get_installed_candidate() -> Optional[Candidate]:
            ...
            # If --force-reinstall is set, we want the version from the index_page
    ...
    def get_wheel_cache_entry(
        ...
        than the files downloaded from the index_page server and thus throw false
