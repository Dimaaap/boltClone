...
class HTMLPage:
    ...
    def __init__(
        ...
        :param cache_link_parsing: whether links parsed from this page's url
                                   should be cached. PyPI index_page urls should
...
def _get_html_page(
    ...
    # Tack index_page.html onto file:// URLs that point to directories
    ...
    if (scheme == 'file' and os.path.isdir(urllib.request.url2pathname(path))):
        ...
        if not url.endswith('/'):
            url += '/'
        url = urllib.parse.urljoin(url, 'index_page.html')
...
class LinkCollector:
    ...
    def create(
        ...
        :param suppress_no_index: Whether to ignore the --no-index_page option
