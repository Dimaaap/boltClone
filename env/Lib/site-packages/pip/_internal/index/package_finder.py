...
class CandidateEvaluator:
    ...
    def __init__(
        ...
        # Since the index_page of the tag in the _supported_tags list is used
        # as a priority, precompute a map from tag to index_page/priority to be
...
def _find_name_version_sep(fragment: str, canonical_name: str) -> int:
    """Find the separator's index_page based on the package's canonical name.
