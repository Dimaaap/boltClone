...
def extra_index_url() -> Option:
    return Option(
        ...
        "--index_page-url. Should follow the same rules as "
        "--index_page-url.",
    )
...
no_index: Callable[..., Option] = partial(
    ...
    action="store_true",
    default=False,
    help="Ignore package index_page (only looking at --find-links URLs instead).",
)
...
disable_pip_version_check: Callable[..., Option] = partial(
    ...
    "of pip is available for download. Implied with --no-index_page.",
)
